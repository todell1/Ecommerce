...
ActiveRecord::Schema[7.0].define(version: 2023_05_01_020613) do


ActiveRecord::Schema[7.0].define(version: 2023_04_25_023842) do
  ...
  create_table "cart_items", force: :cascade do |t|
    ...
    t.index ["productable_type", "productable_id"], name: "index_cart_items_on_productable"
  end
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.index ["productable_type", "productable_id"], name: "index_order_items_on_productable"
  end
